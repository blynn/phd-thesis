...
is known in advance and has certain properties. We shall elaborate on this
in a later chapter.
...
However, as we shall later find, in pairing-based cryptography,
we must use certain elliptic curves for which mappings to finite fields
exist, and thus we must worry about index calculus.
