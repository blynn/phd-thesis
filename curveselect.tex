...
Although asymptotic estimates are available,
the exact efficacy of the Coppersmith attack on characteristic 3 fields
of the sizes shown has yet to be thoroughly investigated.
...
more recent construction by
Brezing and Weng~\cite{bw}, which in turn can be thought of as a specific
approach of a general method suggested by Cocks and Pinch~\cite{cp}.
