...
$k > 1$ is preferred.
However, the Tate pairing turns out to have other benefits.
...
If we move to $\mathbb{F}_{19^2}$,
it can be checked that
$e(R, R) = 17$,  a ninth root of unity.
...
one may become so accustomed to these facts that one may erroneously
