...
the converse is almost true. We present a slighly different proof:
...
Let $q$ be a prime satisfying $q = 3 \bmod 4$.
...
Section~\ref{sec:twistcurveremarks}. Unlike the previous type,
...
The construction is more involved as it uses the CM method (which
we shall encounter soon), and these pairings are
